...
class WmbusParser {
        ...
        switch (apl.ci) {
            ...
            /*case 0x79:
                  if (this.link_layer.manufacturer === 'KAM') {
                      ...
                      this.application_layer.format_signature = this.data.readUInt16LE(this.dataPos);
                      this.dataPos += 2;
                      // full frame payload checksum is not checked!
                      this.application_layer.full_frame_payload_crc = this.data.readUInt16LE(this.dataPos);
                      this.dataPos += 2;
              ...
              case 0xA2:
                  if (this.link_layer.manufacturer === 'TCH') {
                      ...
                      let tchRet = tchDecoder(this.data, this.link_layer);
                      if (tchRet !== false) {
                          this.this.dataRecords = tchRet;
                          return 1;
                          break;
                      }
                  }*/
    ...
    decodeDataRecord() {
        ...
        try {
            ...
            // let dataRecord = this.interpretDataRecord(dataRecordHeader, value);
            // @ts-ignore
